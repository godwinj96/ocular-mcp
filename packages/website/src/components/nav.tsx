            ...
            return (
              <a
                ...
                onClick={(e) => {
                  ...
                  // href carries the route. Intercepting the click keeps that
                  // an SPA navigation instead of a full document load; the
                  // href stays correct for middle-click, copy-link and no-JS.
                  if (onHome) return;
                  e.preventDefault();

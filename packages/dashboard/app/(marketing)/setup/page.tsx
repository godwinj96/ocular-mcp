...
import { CopyableBlock } from '../../../components/marketing/copyable-block';
...
const TITLE = 'Setup — Ocular';
const DESCRIPTION =
  'Two steps to connect Ocular to your agent: one line in your MCP config, then sign in once. Works with any MCP client.';

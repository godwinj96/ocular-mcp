...
import { usePrefersReducedMotion } from '../../hooks/marketing/use-reduced-motion';
import { TesseraDashboard } from './specimen/tessera-dashboard';
import { SpecimenFrame } from './specimen/specimen-frame';
import { useTreeRows, FOLD_Y } from '../../hooks/marketing/use-tree-rows';
import { ReadoutOverlay, useReadoutCycle, reachedAt, CYCLE_MS } from './readout-overlay';

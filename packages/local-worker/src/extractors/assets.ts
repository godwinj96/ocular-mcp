// extract_assets extractor — local path. Same duplication rationale as
// design-tokens.ts. SSRF-safe by construction — rewrites to absolute
// public http(s) URLs only, never resolves or proxies asset bytes.
...
export async function extractAssets(
  ...
  include: ExtractAssetsInput['include'],

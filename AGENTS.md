...
This project is indexed by GitNexus as **ocular-mcp** (1059 symbols, 1621 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

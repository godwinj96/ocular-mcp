...
| -------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| **Local render latency**   | Client-visible round trip for a `view_page` on localhost, cache bypassed       | The core loop. This is the number a developer feels on every verification.                                                                | 11.5s                 |
